...
This package contains the procedural macros exported by the `formally::support` subcrate. This is not meant to be used
directly. Instead, use the main [formally] crate.
